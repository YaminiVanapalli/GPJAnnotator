...
Begin VB.Form frmAnnotator
   ...
   Begin TabDlg.SSTab sst1
      ...
      EndProperty
      TabCaption(0) = "Tab 0"
      TabPicture(0)   =   "frmAnnotator.frx":08CA
   ...
   Begin VB.PictureBox picDirs
      ...
      Begin VB.CommandButton cmdNav
         BackColor = &H0&
         DisabledPicture =   "frmAnnotator.frx":1104
         Enabled = 0             'False
         BeginProperty Font
            Name = "MS Sans Serif"
            Size = 8.25
         ...
         Left = 600
         MaskColor = &H80000002
         MouseIcon       =   "frmAnnotator.frx":140E
         MousePointer = 99       'Custom
         Picture         =   "frmAnnotator.frx":1718
         Style = 1              'Graphical
         TabIndex = 5
      ...
      Begin VB.CommandButton cmdNav
         BackColor = &H0&
         DisabledPicture =   "frmAnnotator.frx":1A22
         Enabled = 0             'False
         BeginProperty Font
            Name = "MS Sans Serif"
            Size = 8.25
         ...
         Left = 60
         MaskColor = &H80000006
         MouseIcon       =   "frmAnnotator.frx":1D2C
         MousePointer = 99       'Custom
         Picture         =   "frmAnnotator.frx":2036
         Style = 1              'Graphical
         TabIndex = 4
      ...
      Begin VB.Image imgIcon
         ...
         Index = 4
         Left = 4680
         MouseIcon       =   "frmAnnotator.frx":2340
         MousePointer = 99       'Custom
         Picture         =   "frmAnnotator.frx":264A
         Stretch = -1            'True
      ...
      Begin VB.Image imgIcon
         ...
         Index = 3
         Left = 4680
         MouseIcon       =   "frmAnnotator.frx":2954
         MousePointer = 99       'Custom
         Picture         =   "frmAnnotator.frx":2C5E
         Stretch = -1            'True
      ...
      Begin VB.Image imgFPS
         Height = 495
         Left = 4680
         MouseIcon       =   "frmAnnotator.frx":2F68
         MousePointer = 99       'Custom
         Picture         =   "frmAnnotator.frx":3272
         Stretch = -1            'True
      ...
      Begin VB.Image imgIcon
         ...
         Index = 1
         Left = 4680
         MouseIcon       =   "frmAnnotator.frx":357C
         MousePointer = 99       'Custom
         Picture         =   "frmAnnotator.frx":3886
         Stretch = -1            'True
      ...
      Begin VB.Label lblFile
         ...
         Index = 19
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":3B90
         TabIndex = 45
         Top = 6660
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 18
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":3E9A
         TabIndex = 44
         Top = 6420
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 17
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":41A4
         TabIndex = 43
         Top = 6180
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 16
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":44AE
         TabIndex = 42
         Top = 5940
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 15
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":47B8
         TabIndex = 41
         Top = 5700
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 14
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":4AC2
         TabIndex = 40
         Top = 5460
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 13
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":4DCC
         TabIndex = 39
         Top = 5220
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 12
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":50D6
         TabIndex = 38
         Top = 4980
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 11
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":53E0
         TabIndex = 37
         Top = 4740
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 10
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":56EA
         TabIndex = 36
         Top = 4500
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 9
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":59F4
         TabIndex = 35
         Top = 4260
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 8
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":5CFE
         TabIndex = 34
         Top = 4020
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 7
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":6008
         TabIndex = 33
         Top = 3780
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 6
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":6312
         TabIndex = 32
         Top = 3540
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 5
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":661C
         TabIndex = 31
         Top = 3300
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 4
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":6926
         TabIndex = 30
         Top = 3060
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 3
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":6C30
         TabIndex = 29
         Top = 2820
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 2
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":6F3A
         TabIndex = 28
         Top = 2580
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 1
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":7244
         TabIndex = 27
         Top = 2340
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Label lblFile
         ...
         Index = 0
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":754E
         TabIndex = 26
         Top = 2100
         UseMnemonic = 0         'False
         Width = 45
      ...
      Begin VB.Image imgTeam
         Height = 495
         Left = 4080
         MouseIcon       =   "frmAnnotator.frx":7858
         MousePointer = 99       'Custom
         Picture         =   "frmAnnotator.frx":7B62
         Stretch = -1            'True
   ...
   Begin VB.PictureBox picDir
      ...
      Begin VB.OptionButton optSort
         DisabledPicture =   "frmAnnotator.frx":7E6C
         DownPicture     =   "frmAnnotator.frx":8736
         BeginProperty Font
            Name = "MS Sans Serif"
            Size = 8.25
            Charset = 0
      ...
      End
      Begin VB.OptionButton optSort
         DownPicture     =   "frmAnnotator.frx":930A
         BeginProperty Font
            Name = "MS Sans Serif"
            Size = 8.25
            Charset = 0
      ...
      Begin MSComctlLib.TreeView tvw2
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851}
            ...
            Strikethrough = 0       'False
         EndProperty
         MouseIcon = "frmAnnotator.frx": A1E8
      End
      Begin MSComctlLib.ImageList imlSkins
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628}
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628}
               Picture = "frmAnnotator.frx": A502
               Key = ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628}
               Picture = "frmAnnotator.frx": E99FE
               Key = ""
            EndProperty
         EndProperty
      End
      Begin MSFlexGridLib.MSFlexGrid flx1
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851}
            ...
            Strikethrough = 0       'False
         EndProperty
         MouseIcon       =   "frmAnnotator.frx":1C8EFA
      End
   ...
   Begin VB.PictureBox picRelatives
      ...
      Begin VB.Image imgInfo
         Height = 555
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":1C9214
         MousePointer = 99       'Custom
         Picture         =   "frmAnnotator.frx":1C951E
         Stretch = -1            'True
      ...
      Begin VB.Image imgDWF
         ...
         Index = 0
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":1C9828
         MousePointer = 99       'Custom
         Picture         =   "frmAnnotator.frx":1C9B32
         Stretch = -1            'True
      ...
      Begin VB.Image imgDWF
         ...
         Index = 1
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":1C9E3C
         MousePointer = 99       'Custom
         Picture         =   "frmAnnotator.frx":1CA146
         Stretch = -1            'True
      ...
      Begin VB.Image imgDWF
         ...
         Index = 2
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":1CA450
         MousePointer = 99       'Custom
         Picture         =   "frmAnnotator.frx":1CA75A
         Stretch = -1            'True
      ...
      Begin VB.Image imgDWF
         ...
         Index = 3
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":1CAA64
         MousePointer = 99       'Custom
         Picture         =   "frmAnnotator.frx":1CAD6E
         Stretch = -1            'True
      ...
      Begin VB.Image imgDWF
         ...
         Index = 4
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":1CB078
         MousePointer = 99       'Custom
         Picture         =   "frmAnnotator.frx":1CB382
         Stretch = -1            'True
      ...
      Begin VB.Image imgDWF
         ...
         Index = 5
         Left = 240
         MouseIcon       =   "frmAnnotator.frx":1CB68C
         MousePointer = 99       'Custom
         Picture         =   "frmAnnotator.frx":1CB996
         Stretch = -1            'True
      ...
      Begin VB.Image imgGraphics
         Height = 555
         Left = 1320
         MouseIcon       =   "frmAnnotator.frx":1CBCA0
         MousePointer = 99       'Custom
         Picture         =   "frmAnnotator.frx":1CBFAA
         Stretch = -1            'True
      ...
      Begin VB.Image imgConst
         Height = 435
         Left = 1380
         MouseIcon       =   "frmAnnotator.frx":1CC0F4
         MousePointer = 99       'Custom
         Picture         =   "frmAnnotator.frx":1CC3FE
   ...
   Begin VOLOVIEWXLibCtl.AvViewX volFrame
      ...
      LayersOff = ""
      SrcTemp = ""
      SupportPath     =   $"frmAnnotator.frx":1CC526
      FontPath        =   $"frmAnnotator.frx":23907A
      NamedView = ""
   ...
   Begin VB.Image imgDirs
      Height = 480
      Left = 60
      MouseIcon       =   "frmAnnotator.frx":271F00
      MousePointer = 99       'Custom
      Picture         =   "frmAnnotator.frx":27220A
   ...
   Begin VB.Label lblClose
      ...
      BackColor = &HFFFF&
      BackStyle = 0          'Transparent
      Caption = "Close Space Plan Viewer"
      BeginProperty Font
         Name = "Tahoma"
         Size = 9
         Charset = 0
      ...
      Height = 480
      Left = 9480
      MouseIcon       =   "frmAnnotator.frx":272D54
      MousePointer = 99       'Custom
      TabIndex = 72
      Top = 60
      Width = 1290
   ...
   Begin VB.Label lblSettings
      ...
      Height = 195
      Left = 9660
      MouseIcon       =   "frmAnnotator.frx":27305E
      MousePointer = 99       'Custom
      TabIndex = 71
      Top = 720
      Visible = 0             'False
   ...
   Begin VB.Label lblMenu
      ...
      Height = 240
      Left = 308
      MouseIcon       =   "frmAnnotator.frx":273368
      MousePointer = 99       'Custom
      TabIndex = 66
      Top = 765
      Visible = 0             'False
   ...
   Begin VB.Image imgMenu
      Height = 570
      Left = 0
      Picture         =   "frmAnnotator.frx":273672
      Top = 600
      Visible = 0             'False
      Width = 1080
   End
   Begin VB.Image imgMail
      ...
      Index = 3
      Left = 11220
      Picture         =   "frmAnnotator.frx":2756C6
      Top = 4080
      Visible = 0             'False
      Width = 480
   End
   ...
   Begin VB.Image imgLock
      Height = 405
      Left = 11100
      MouseIcon       =   "frmAnnotator.frx":2759D0
      MousePointer = 99       'Custom
      Picture         =   "frmAnnotator.frx":275CDA
      Stretch = -1            'True
      Top = 90
      Visible = 0             'False
      Width = 360
   ...
   Begin VB.Label lblReds
      ...
      Height = 195
      Left = 1860
      MouseIcon       =   "frmAnnotator.frx":275FE4
      TabIndex = 51
      Top = 788
      UseMnemonic = 0         'False
      Width = 45
   ...
   Begin VB.Image imgComm
      Height = 480
      Left = 1200
      MouseIcon       =   "frmAnnotator.frx":2762EE
      MousePointer = 99       'Custom
      Picture         =   "frmAnnotator.frx":2765F8
      Top = 645
      Visible = 0             'False
      Width = 480
   End
   Begin VB.Image imgMail
      ...
      Index = 0
      Left = 11100
      Picture         =   "frmAnnotator.frx":276A3A
      Top = 2160
      Visible = 0             'False
      Width = 480
   End
   Begin VB.Image imgMail
      ...
      Index = 1
      Left = 11100
      Picture         =   "frmAnnotator.frx":276E7C
      Top = 2700
      Visible = 0             'False
      Width = 480
   End
   Begin VB.Image imgMail
      ...
      Index = 2
      Left = 11100
      Picture         =   "frmAnnotator.frx":2772BE
      Top = 3240
      Visible = 0             'False
      Width = 480
   End
   ...
   Begin VB.Menu mnuRightClick
      ...
      Begin VB.Menu mnuRedlining
         ...
         End
      End
      Begin VB.Menu mnuRedArchive
         Caption = "Redline Archive..."
         Visible = 0             'False
      End
...
Dim fSHCD As Long
Dim bDirsOpen As Boolean, bPopped As Boolean
...
Private Sub chkFPApprove_Click()
    ...
    flx1.Visible = False
    cmdFPS.Visible = False
    tvw2.Height = picDir.ScaleHeight - tvw2.Top - tvw2.Left '' 6015
    lblSettings.Visible = False
    chkClose.Visible = False
    cmdFPS.Visible = False
    optSort(0).Visible = False
    optSort(1).Visible = False
    cmdFPSI.Visible = False
    ...
    If sNode <> "" Then
        ...
        If Err = 0 Then Call tvw2_NodeClick(tvw2.Nodes(sNode))
    End If
...
'''    Dim i As Integer
'''    For i = 0 To flx1.Cols - 1
'''        MsgBox "Col " & i & " width = " & flx1.ColWidth(i)
'''    Next i
End Sub
...
'    MsgBox "Left=" & cmdFPS.Left & vbNewLine & _
'            "Top=" & cmdFPS.Top & vbNewLine & _
'            "Width=" & cmdFPS.Width & vbNewLine & _
'            "Height=" & cmdFPS.Height
...
Private Sub lblReds_Click()
    If InStr(1, lblReds.Caption, "click this link") <> 0 Then
        Call mnuRedLoad_Click
    End If
End Sub
...
'    MsgBox "Left=" & flx1.Left & vbNewLine & _
'            "Top=" & flx1.Top & vbNewLine & _
'            "Width=" & flx1.Width & vbNewLine & _
'            "Height=" & flx1.Height
...
Private Sub Form_Resize()
    ...
    If Me.WindowState <> 1 Then
        If Me.Width > 2000 And Me.Height > 2000 Then
            ...
            cmd1.Width = picDir.Width
            cmd1.Height = picDir.Height
            cmdFPSI.Left = picDir.ScaleWidth - tvw2.Left - cmdFPSI.Width
            optSort(1).Left = picDir.ScaleWidth - tvw2.Left - optSort(1).Width
            optSort(0).Left = optSort(1).Left - optSort(0).Width
            
            flx1.Width = picDir.ScaleWidth - (flx1.Left * 2)
            flx1.Height = picDir.ScaleHeight - flx1.Top - flx1.Left
            If flx1.Width > 9000 Then Call SizeGrid
            
            If Not bPopped Then
                tvw2.Height = picDir.ScaleHeight - tvw2.Top - tvw2.Left
            End If
            
            volFrame.Width = Me.ScaleWidth - imgMenu.Width - 120
            volFrame.Height = Me.ScaleHeight - imgMenu.Top - imgMenu.Height - 120
            
'''            imgClose.Left = Me.ScaleWidth - imgClose.Width
            lblSettings.Left = Me.ScaleWidth - lblSettings.Width '' imgClose.Left + (imgClose.Width / 2) - (lblSettings.Width / 2)
            lblClose.Left = Me.ScaleWidth - lblClose.Width '' imgClose.Left + (imgClose.Width / 2) - (lblClose.Width / 2)
...
'            picFPApprove.Left = volFrame.Left + volFrame.Width - 90 - picFPApprove.Width
            ...
            lblByGeorge(0).Left = Me.ScaleWidth - 240 - lblByGeorge(0).Width
            lblByGeorge(0).Top = Me.ScaleHeight - 240 - lblByGeorge(0).Height
...
'''            cboCUNO.Width = (flx1.Left + flx1.ColWidth(0) + flx1.ColWidth(1)) - cboCUNO.Left
            tvw2.Width = cmdFPS.Left - tvw2.Left - 120 - 30
            Debug.Print "Top=" & tvw2.Top & ", Left=" & tvw2.Left & ", Width=" & tvw2.Width & ", Height=" & tvw2.Height
            
            chkFPApprove.Left = tvw2.Left + tvw2.Width + 120
...
Private Sub imgComm_Click()
    With frmComments
        .PassREFID = lDWGID
        .PassTable = "ANNOTATOR.DWG_MASTER"
        .PassIType = 0
        .PassBCC = BCC
        .PassFBCN = FBCN
        .PassSHCD = SHCD
...
'''        Set imgDirs.Picture = imlDirs.ListImages(2).Picture
        If bPerm(17) And volFrame.Visible = True Then imgComm.Visible = True
        ...
        End If
    End If
    If bMenuButton And volFrame.Visible = True Then
...
'        picFrame.Visible = False
        ...
        If bMenuButton And chkClose.Value = 1 Then
            lblMenu.Visible = True
            imgMenu.Visible = True
            bDirsOpen = False
            imgDirs.ToolTipText = "Click to Open File Index..."
...
Private Sub mnuRedArchive_Click()
    iRightClick = 1
    frmRedArchive.PassDWGID = lDWGID
    timRightClick.Enabled = True
...
Private Sub mnuRedDelete_Click()
    ...
    Dim strSelect As String, strDelete As String, sCheck As String, strUpdate As String
    Dim rst As ADODB.Recordset
    Dim sMess As String
    ...
    If bTeamMember Then
        ...
        If Resp = vbYes Then
            ...
            ''DELETE CHANGED TO A DWFSTATUS = -99 BY SAW ON 01.24.2005''
...
'''            Conn.Execute (strDelete)
            ...
            strUpdate = "UPDATE ANNOTATOR.DWG_DWF SET " & _
                        "DWFSTATUS = -99, " & _
...
'''            Kill RedFile
            ...
            '///// NOTE DELETE IN COMMENT LOG \\\\\'
            sMess = "Redline File Deleted by " & LogName
            Call InsertArchiveComment(lDWGID, "ANNOTATOR.DWG_MASTER", sMess)
    
            '///// NOW, CLEAN UP \\\\\
            lRedID = 0
            RedFile = ""
            If Not bRedArchive Then
                lblReds.Caption = "NO Redline File exists for this Floor Plan."
                lblReds.MousePointer = 0
                lblReds.ForeColor = vbWhite
            ElseIf bRedArchive Then
                lblReds.Caption = "NO Redline File exists for this Floor Plan, " & _
                            "but a Redline Archive is available on the Viewer Menu."
                lblReds.MousePointer = 0
                lblReds.ForeColor = vbWhite
            End If
...
Private Sub mnuRedMode_Click()
    ...
    ElseIf volFrame.src <> RedFile Then
        Resp = MsgBox("A Redline File already exists, but is not currently loaded." & _
                    ...
                    vbCr & vbCr & "NOTE: Original Redline will be Archived.", _
                    vbYesNo + vbCritical + vbDefaultButton2, "Existing Redline File...")
        If Resp = vbYes Then
            Call ArchiveRedline(lDWGID, lRedID)
            ClearChecks
            mnuRedMode.Checked = True
            mnuTextMode.Checked = False
            volFrame.UserMode = "Sketch"
...
Private Sub mnuRedSave_Click()
    ...
    If RedFile = "" Then
        ...
        strInsert = "INSERT INTO " & DWGDwf & " " & _
                    ...
                    "'REDLINE', '" & sDWFPath & CStr(lDWFID) & ".dwf" & "', 20, " & _
                    "'" & DeGlitch(Left(LogName, 24)) & "', SYSDATE, '" & DeGlitch(Left(LogName, 24)) & "', SYSDATE, 1)"
        Conn.Execute (strInsert)
...
Private Sub timRightClick_Timer()
    ...
    Select Case iRightClick
        Case 1 ''mnuRedArchive''
'''            frmRedArchive.PassDWGID = lDWGID
            frmRedArchive.Show 1, Me
        Case 2 ''mnuEmailPDF''
            With frmEmailFile
                .PassBCC = BCC
                .PassFBCN = FBCN
                ...
                .PassSHDT = sShowDates
                .PassFrom = Me.Name
                .PassTTT = "Attachments (Right-click File to Preview):"
                .Show 1
            End With
        Case 3 ''mnuEng''
            frmEngDWG.PassLink = sLinkID
            frmEngDWG.Show 1, Me
        Case 4 ''mnuPhoto''
            'Screen.MousePointer = 11
            frmPhoto.PassLink = sLinkID
...
Private Sub Form_Load()
    ...
    For i = 0 To 19
        lblFile(i).ForeColor = RGB(150, 150, 102)
    Next i
'''    chkFPApprove.BackColor = RGB(111, 175, 28)
'''    chkClose.BackColor = RGB(111, 175, 28)
    
'''    sDWFPath = "\\DETMSFS01\GPJAnnotator\Floorplans\"
    sDWFPath = "\\DETMSFS01\GPJAnnotator\Floorplans\"
    ...
    sZMode = "Zoom"
    volFrame.UserMode = sZMode
    volFrame.Top = imgMenu.Top + imgMenu.Height '' 675 '''120
    volFrame.Left = imgMenu.Width + 120 '' 120
    volFrame.Width = Me.ScaleWidth - volFrame.Left - 120 - 120 '' Me.Width - 360
    volFrame.Height = Me.ScaleHeight - volFrame.Top - 120 '' Me.Height - 1230 ''' volFrame.Width * 2 / 3
    volFrame.src = ""
    volFrame.Visible = False
...
'    picFrame.Visible = True
    ...
    imgDirs.Left = 60 '' 120 ''180 ''' Screen.Width - imgDirs.Width - 240
    imgDirs.Top = 60 '' 120 ''180
...
'    lblReds.Left = lblWelcome.Left ''' 120
    ...
    lblByGeorge(0).ForeColor = lGeo_Dark ''   lGeo_Back '' RGB(30, 30, 21)
...
'''        Set imgDirs.Picture = imlDirs.ListImages(4).Picture
    ...
    flx1.ColWidth(0) = 4400
    flx1.ColWidth(1) = 2000
...
'Private Sub tvw2_Click()
'    MsgBox "Left=" & tvw2.Left & vbNewLine & _
'            "Top=" & tvw2.Top & vbNewLine & _
'            "Width=" & tvw2.Width & vbNewLine & _
'            "Height=" & tvw2.Height
'End Sub
...
'            If bApprovalList Then
            ...
            bDirsOpen = False
            Call PopFloorplans(fSHYR, CLng(fBCC))
            If tvw2.Height <> 1695 Then
'''                Set picDir.Picture = imlSkins.ListImages(2).Picture
                tvw2.Height = 1695
                bPopped = True
            End If
            picDir.Visible = True
...
'            Set imgDirs.Picture = imlDirs.ListImages(4).Picture
            chkClose.Visible = True
            cmdFPS.Visible = True
            optSort(0).Visible = True
            optSort(1).Visible = True
            cmdFPSI.Visible = True
...
'        picFrame.Visible = True
    ...
    If bPerm(13) Then
        ...
        Else
            ...
            lblReds.MousePointer = 99
            lblReds.ForeColor = vbRed
            mnuRedLoad.Enabled = True
            mnuRedDelete.Enabled = False
            mnuRedClear.Enabled = False
            mnuRedSave.Enabled = False
...
Public Sub LockAlert()
    ...
    MessBody = "You are documented as currently accessing the following " & _
                ...
                "before leaving the file.  If you and I each save, the Annotations could be overwritten." & _
                vbNewLine & _
                vbNewLine & _
                LogName
...
Public Sub PopClients()
    ...
    If bClientAll_Enabled Then
        strSelect = "SELECT DISTINCT SHO.AN8_CUNO, C.ABALPH, SHO.SHYR " & _
                    ...
                    "AND C.ABAT1 = 'C' " & _
                    "ORDER BY C.ABALPH, SHO.AN8_CUNO, SHO.SHYR"
'''        strSelect = "SELECT DISTINCT SHO.AN8_CUNO, C.ABALPH, SHO.SHYR " & _
...
'''            flx1.Text = "n"
            flx1.CellBackColor = lGeo_Bright '' lColor2 ' vbActiveTitleBar
        Next i
...
Public Sub SizeGrid()
    ...
    flx1.Row = 0
    flx1.Col = 0: flx1.ColAlignment(0) = 1
                flx1.CellAlignment = 4: flx1.Text = "Show <Click to view Floorplan>"
    flx1.Col = 1: flx1.ColAlignment(1) = 4: flx1.CellAlignment = 4: flx1.Text = "Show Dates"
    For i = 1 To 8
        flx1.Col = i + 1: flx1.ColWidth(i + 1) = (flx1.Width - 240 - 6400) / 8: flx1.ColAlignment(i + 1) = 4
        Select Case i
...
Public Sub PopFloorplans(tSHYR As Integer, tCUNO As Long)
    ...
    If Not bApprovalList Then
        ...
        SelClause(0) = "SELECT SM.SHY56SHCD, TRIM(SM.SHY56NAMA) AS SHY56NAMA, CS.CSY56CUNO, CU.ABALPH, " & _
                    ...
                    "" & F0101 & " CU, AQUA.AQUA_FLOORPLAN_STATUS FPS, " & DWGShow & " DS " & _
                    ...
                    "AND FPS.FPSTATUS > 3 " & _
                    "AND SM.SHY56SHYR = DS.SHYR " & _
                    "AND SM.SHY56SHCD = DS.AN8_SHCD " & _
                    "AND CS.CSY56CUNO = DS.AN8_CUNO " & _
                    "AND CS.CSY56CUNO = CU.ABAN8 "
                    
                
        '///// SELCLAUSE(1) IS USED IF ALL FLOORPLANS ARE TO BE DISPLAYED \\\\\
        SelClause(1) = "SELECT SM.SHY56SHCD, TRIM(SM.SHY56NAMA) AS SHY56NAMA, CS.CSY56CUNO, CU.ABALPH, " & _
                    "IGL_JDEDATE_TOCHAR(SM.SHY56BEGDT, 'DD-MON-YYYY')BEG_DATE, " & _
                    "IGL_JDEDATE_TOCHAR(SM.SHY56ENDDT, 'DD-MON-YYYY')END_DATE, " & _
                    "FPS.FPSTATUS, FPS.FPSTATDT " & _
                    "FROM " & F5601 & " SM, " & F5611 & " CS, " & _
                    "" & F0101 & " CU, AQUA.AQUA_FLOORPLAN_STATUS FPS " & _
                    "WHERE CS.CSY56CUNO = " & tCUNO & " " & _
                    "AND SM.SHY56SHYR = " & tSHYR & " " & _
                    "AND SM.SHY56SHCD = CS.CSY56SHCD " & _
                    "AND SM.SHY56SHYR = CS.CSY56SHYR " & _
...
'''    End If
    ...
    strSelect = "SELECT M.DWGID, DWF.SHTID, DWF.DWFID, " & _
                "DWF.DWFTYPE, DWF.DWFPATH, M.DSTATUS, DWF.DWFSTATUS " & _
                "From " & DWGShow & " SHO, " & DWGMas & " M, " & _
                "" & DWGSht & " SHT, " & DWGDwf & " DWF " & _
                "WHERE SHO.DWGID = M.DWGID  " & _
                "AND M.DWGID = SHT.DWGID " & _
    ...
    If Not rst.EOF Then
        ...
        ''CHECK FOR REDLINE ARCHIVE''
        strSelect = "SELECT COUNT(DWFID) AS CNT FROM " & DWGDwf & " " & _
                    "WHERE DWGID = " & lDWGID & " " & _
                    "AND DWFSTATUS = 0"
        Set rst2 = Conn.Execute(strSelect)
        If rst2.Fields("CNT") = 0 Then
            mnuRedArchive.Visible = False
        Else
            mnuRedArchive.Visible = True
        End If
        rst2.Close: Set rst2 = Nothing
        bRedArchive = mnuRedArchive.Visible
...
'''                "AND C.ABAT1 = 'C' " & _
'''                "ORDER BY C.ABALPH, SHO.SHYR"
    strSelect = "SELECT DISTINCT FPS.AN8_CUNO, C.ABALPH, FPS.SHYR  " & _
                "FROM AQUA.AQUA_FLOORPLAN_STATUS FPS, " & F0101 & " C " & _
                "WHERE FPS.AN8_CUNO IN (" & sList & ") " & _
                "AND FPS.FPSTATUS = 4 " & _
                "AND FPS.AN8_CUNO = C.ABAN8 " & _
                "AND C.ABAT1 = 'C' " & _
                "ORDER BY C.ABALPH, FPS.SHYR"
    Set rst = Conn.Execute(strSelect)
    Do While Not rst.EOF
        If sCNode <> "c" & Right("00000000" & rst.Fields("AN8_CUNO"), 8) Then
            sCNode = "c" & Right("00000000" & rst.Fields("AN8_CUNO"), 8)
...
Public Sub ArchiveRedline(pDWGID As Long, pRedID As Long)
    Dim strUpdate As String, sMess As String
    
    strUpdate = "UPDATE " & DWGDwf & " SET " & _
                "DWFSTATUS = 0, " & _
                "UPDUSER = '" & Left(DeGlitch(LogName), 24) & "', " & _
                "UPDDTTM = SYSDATE, UPDCNT = UPDCNT + 1 " & _
                "WHERE DWFID = " & pRedID
    ...
    sMess = "Redline File Archived by " & LogName
    Call InsertArchiveComment(pDWGID, "ANNOTATOR.DWG_MASTER", sMess)
End Sub

Public Sub InsertArchiveComment(pDWGID As Long, pRefTable As String, pComm As String)
    Dim lCOMMID As Long
    Dim rstL As ADODB.Recordset
    ...
    strInsert = "INSERT INTO " & ANOComment & " " & _
                ...
                "ADDUSER, ADDDTTM, UPDUSER, UPDDTTM, UPDCNT) " & _
                "VALUES " & _
                "(" & lCOMMID & ", " & pDWGID & ", '" & pRefTable & "', '" & DeGlitch(pComm) & "', " & _
                "'" & DeGlitch(Left(LogName, 24)) & "', SYSDATE, 1, " & _
                "'" & DeGlitch(Left(LogName, 24)) & "', SYSDATE, '" & DeGlitch(Left(LogName, 24)) & "', SYSDATE, 1)"
    Conn.Execute (strInsert)
...
Public Sub RestackRelatives()
    Dim i As Integer, iCnt As Integer
    
    iCnt = -1
    For i = imgDWF.LBound To imgDWF.UBound
        If imgDWF(i).Visible Then
            iCnt = iCnt + 1
            imgDWF(i).Top = 60 + (iCnt * 600)
        End If
    Next i
    If imgInfo.Visible Then
        iCnt = iCnt + 1
        imgInfo.Top = 60 + (iCnt * 600)
    End If
    If cmdOther.Visible Then
        iCnt = iCnt + 1
        cmdOther.Top = 60 + (iCnt * 600)
    End If
    
        
End Sub

Public Function CheckForENG(tLink As String) As Boolean
    Dim tCUNO As Long
    Dim sElt As String, strSelect As String
    Dim rst As ADODB.Recordset
    Dim bChk As Boolean
    
    tCUNO = CLng(Left(tLink, 8))
    sElt = Mid(tLink, 10)
    strSelect = "SELECT COUNT(DWGID) AS CNT " & _
                "From ANNOTATOR.DWG_ELEMENT " & _
                "WHERE INVID IN (" & _
                    "SELECT E.ELTID " & _
                    "FROM IGLPROD.IGL_KIT K, IGLPROD.IGL_ELEMENT E " & _
                    "Where K.AN8_CUNO = " & tCUNO & " " & _
